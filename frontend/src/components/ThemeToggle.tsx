...
export default function ThemeToggle() {
  ...
  const toggle = () => {
    ...
    localStorage.setItem("techpulse-theme", next ? "dark" : "light");
  };

  return (
    <button onClick={toggle} aria-label="테마 전환" className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-[#334155] transition">
      {isDark ? (
